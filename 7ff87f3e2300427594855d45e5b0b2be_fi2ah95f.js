...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var res = ObjectStore.updateById("GT36354AT20.GT36354AT20.abnormalevent", object);
    //获取当前用户的员工信息-------------------------------------------------------------------
    ...
    var belongArea = "select '' as id ,id as areaid from GT36354AT20.GT36354AT20.area where StaffNew='" + psnid + "'";
    var belongR = ObjectStore.queryByYonQL(belongArea);
    if (undefined == belongR || belongR.length == 0) {
      var belongStore = "select id,area.id as areaid from GT36354AT20.GT36354AT20.store where StaffNew='" + psnid + "'";
    ...
    var looklogresult = ObjectStore.insert("GT36354AT20.GT36354AT20.looklog", looklog, "6b823eff");
    return { result: true };
  }
}
