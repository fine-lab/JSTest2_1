...
viewModel.get("orgregister_1795211255161552904") &&
  viewModel.get("orgregister_1795211255161552904").on("afterSetDataSource", function (data) {
    //企业产权登记--设置数据源后
    ...
    rows.forEach((data) => {
      ...
      actions.forEach((action) => {
        ...
        if (data.verifystate == 1 || data.verifystate == 2 || data.verifystate == 3) {
          if (action.cItemName == "button25yi") {
