...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var code4 = request.code;
    var PurDATES = PurDATEES(access_token, code4);
    //获取采购接口方法
    function PurDATEES(access_token, code) {
      //设置返回的access_token
      // 获取token的url
      ...
      const requestUrl = token_url + "?access_token=" + access_token + "&id=" + code;
