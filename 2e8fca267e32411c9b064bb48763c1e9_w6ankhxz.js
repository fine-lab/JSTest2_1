...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let sql = "select ysappkey,ysappsecret,hunpunkey,hunpunsecret from AT15F21D9001880006.AT15F21D9001880006.hunPun_config where dr=0 and tenantId='" + tid + "'";
    ...
    var strResponse = postman("POST", res.url + "/otherWarehouse/otherWarehouseTask", null, JSON.stringify(config));
  }
}
