...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var ogid = obj.currentUser.orgId;
    ...
    var stockarea = "select * from IDX_02.IDX_02.dxq_checkresult where checkID='" + stockId + "' and dr=0 and (checkstatus=0||checkstatus=2)" + tidsql;
    ...
    if (data !== null && data.length > 0) {
      ...
      //将数据插入到差异表
      var result = ObjectStore.insert("IDX_02.IDX_02.dxq_checkdiff", objs, "af2e6364");
    }
    var objectchuli = {
      id: stockId,
      ShenheStatus: 1,
