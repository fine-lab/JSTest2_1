...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var sql = "select * from GT60601AT58.GT60601AT58.inCertContract where dr=0 and innerStatus in(1,2) and verifystate=2 and cer_due_date='" + nowstr + "'";
    ...
    for (var i = 0; i < res.length; i++) {
      ...
      var channels = ["uspace"];
      var title = "内部收证合同到期预警";
      var content = "内部收证合同号【" + data.receiContract_code + "】,30天后即将过期";
      var messageInfo = {
        sysId: "yourIdHere",
        tenantId: "yourIdHere",
