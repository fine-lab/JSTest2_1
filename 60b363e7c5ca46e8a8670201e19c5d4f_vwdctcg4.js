...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    //测试租户
    //正式租户
    var access_token = getToken("46df0708d1ae44479a4920f7610eff40", "8faaf3dda7c747d1b9bf745f709b6c4d");
    //获取token方法
    function getToken(yourappkey, yourappsecrect) {
      ...
      let tokenUrl = uriRes.domainurl.tokenUrl;
      const token_url = tokenUrl + "/open-auth/selfAppAuth/getAccessToken";
