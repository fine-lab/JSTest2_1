...
!(function () {
  ...
  var w = (function () {
      ...
      return (
        (t.prototype.draw = function (t) {
          ...
          function i(t, e) {
            var r = document.createElementNS("https://www.example.com/", t);
          ...
          n.setAttributeNS("https://www.example.com/", "xmlns:xlink", "https://www.example.com/"),
            r.appendChild(n),
            n.appendChild(i("rect", { fill: e.colorLight, width: "100%", height: "100%" })),
            n.appendChild(i("rect", { fill: e.colorDark, width: "1", height: "1", id: "youridHere" }));
          for (var a = 0; a < o; a++)
            for (var s = 0; s < o; s++)
              if (t.isDark(a, s)) {
                var h = i("use", { x: String(s), y: String(a) });
                h.setAttributeNS("https://www.example.com/", "href", "#template"), n.appendChild(h);
              }
        }),
                ...
                for (var l = 0; l < i; l++)
                  for (var u = 0; u < i; u++) {
                    ...
                    (r.strokeStyle = f ? o.colorDark : o.colorLight),
                      ...
                      r.fillRect(g, d, n, a),
                      r.strokeRect(Math.floor(g) + 0.5, Math.floor(d) + 0.5, s, h),
                      r.strokeRect(Math.ceil(g) - 0.5, Math.ceil(d) - 0.5, s, h);
                  }
                this._bIsPainted = !0;
              }),
  ...
  ((QRCode = function (t, e) {
    if (((this._htOption = { width: 256, height: 256, typeNumber: 4, colorDark: "#000000", colorLight: "#ffffff", correctLevel: o.H }), "string" == typeof e && (e = { text: e }), e))
