...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    if (chuliType === "1") {
      ...
      var sqlsel = "  select * from IDX_02.IDX_02.dxq_checkresult where id=" + checkResultID + " and dr=0";
    ...
    //标签损坏处理
      ...
      if (resselr !== null) {
        var sqlwarehouseId = "select * from IDX_02.IDX_02.dxq_location where id=" + resselr.checkLocationID + " ";
    ...
    var objectchuli = {
      id: checkResultID,
      iHandelMethod: chuliType,
      HandeluserID: userids,
      HandelTime: HandelTimesel
    };
    var resuphulue = ObjectStore.updateById("IDX_02.IDX_02.dxq_checkresult", objectchuli, "31a27d3b");
    return {
      res: "处理成功！"
    };
  }
