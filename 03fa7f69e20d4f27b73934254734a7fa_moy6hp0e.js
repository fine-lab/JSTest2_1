...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    try {
      ...
      //收货地址
      sql1 =
        "select b.id,b.addressCode,b.address,b.receiver receiver,c.define1 ,c.define2,b.zipCode from aa.merchant.Merchant inner join aa.merchant.AddressInfo b on b.merchantId=id left join aa.merchant.AddressInfoDefine c on c.id=b.id  where code='" +
        request.agentId +
        "' and b.addressCode='" +
        request.define3 +
        "'";
      ...
      if (receiveInfo.length > 0) {
        body.data.receiveAddress =
          ...
          " " +
          (receiveInfo[0].c_define2 || "") +
          " " +
          (receiveInfo[0].b_zipCode || "") +
          " " +
          (receiveInfo[0].c_define1 || "") +
          " " +
      ...
      if (define5Info.length > 0) {
        ...
        body.data.headFreeItem.define7 =
          (define5Info[0].b_address || "") +
          " " +
          (define5Info[0].c_define2 || "") +
          " " +
          (define5Info[0].b_zipCode || "") +
          " " +
          (define5Info[0].c_define1 || "") +
          " " +
      ...
      if (dtMerchantDefine.length > 0) {
        ...
        body.data.headFreeItem.define15 = body.data.headFreeItem.define15.replace("%", "");
        body.data.headFreeItem.define16 = body.data.headFreeItem.define16.replace("%", "");
        body.data.headFreeItem.define17 = body.data.headFreeItem.define17.replace("%", "");
      }
      ...
      for (var i = 0; i < orderDetails.length; i++) {
        ...
        Detail.bodyFreeItem.define6 = "EAN " + orderDetails[i].productId + " Käufer Art." + orderDetails[i].define11; //from edi
        //查询物料
