function init(event) {
  ...
  viewModel.get("button813kc").on("click", function (event) {
    //获取新增子类时的行数据
    ...
    let resp = cb.rest.invokeFunction("696bb84e333546d09cd779d5c8e79feb", { qualificationClassification: parentRow[0].id }, null, viewModel, { async: false });
  ...
  treeModel.on("afterSetDataSource", function (event) {
    ...
    let resp = cb.rest.invokeFunction("40d42db355aa48799c7b73f80769668f", {}, null, viewModel, { async: false });
