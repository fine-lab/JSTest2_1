...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let tokenFun = extrequire("GT16765AT90.common.getToken");
    ...
    var detailsql = "select org,dept,project,project_type,employee_compensation,amount from GT16765AT90.GT16765AT90.laborcostdetail where laborcostdetailFk ='" + businessid + "'";
    var detail = ObjectStore.queryByYonQL(detailsql);
    let exchangeRateFun = extrequire("GT16765AT90.common.getExchangeRateType");
    ...
    let currencyFun = extrequire("GT16765AT90.common.getCurrency");
    let currencyResp = currencyFun.execute({ access_token: access_token }, null);
    let currency = currencyResp.currency;
    let vouchertypeFun = extrequire("GT16765AT90.common.getVoucherType");
    ...
    let projectFun = extrequire("GT16765AT90.common.getProject");
    let projecttypeFun = extrequire("GT16765AT90.common.getprojecttype");
    let deptFun = extrequire("GT16765AT90.common.getdept");
    ...
    for (let detailvo of detail) {
      ...
      //关联查询报错，暂时使用该方案
      var subcontrastsql = "select id from GT16765AT90.GT16765AT90.subcontrast where org = '" + detailvo.org + "'";
      ...
      var debitsql =
        "select debit_subject from GT16765AT90.GT16765AT90.subcontrastdetail where subcontrastdetailFk in (" + conids + ") and dept= '" + detailvo.dept + "' and project_type = '" + project_type + "'";
      ...
      var creditsql =
        "select credit_subject from GT16765AT90.GT16765AT90.subcontrastcredit where subcontrastcreditFk in (" + conids + ") and employee_compensation = '" + detailvo.employee_compensation + "'";
    ...
    let voucherSaveFun = extrequire("GT16765AT90.common.postVoucherSave");
    ...
    if ("200" === result.code) {
      ...
      var res = ObjectStore.updateById("GT16765AT90.GT16765AT90.laborcost", object, "laborcost");
    }
    return {
      resp,
      voucherSaveResp
