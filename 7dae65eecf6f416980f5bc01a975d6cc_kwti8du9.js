...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let warehouseId = "";
    let customerId = "";
    if (arrivalOrders[0].stockOrgId == "2522102344422656") {
      //依安工厂
      warehouseId = "yourIdHere";
      customerId = "yourIdHere";
    } else if (arrivalOrders[0].stockOrgId == "2390178757465088") {
      //克东
      warehouseId = "yourIdHere";
      customerId = "yourIdHere";
    } else if (arrivalOrders[0].stockOrgId == "2369205391741184") {
      customerId = "001";
      if (includes(arrivalOrders[0].stockCode, "KSDS")) {
        warehouseId = "KSDS";
      } else if (includes(arrivalOrders[0].stockCode, "XADS") || includes(arrivalOrders[0].stockCode, "XAGK")) {
        warehouseId = "XADS";
      } else if (includes(arrivalOrders[0].stockCode, "SZC")) {
        warehouseId = "KSDS";
      }
    }
    let body = {
