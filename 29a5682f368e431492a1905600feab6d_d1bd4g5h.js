...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    let access_token = getToken("476c0c7fd9fe4b3388a3d67bf442b99d", "93481525ec134fcbaf0d436e8c054e28");
    var datas = request.data;
    var resultcustsql = ObjectStore.queryByYonQL("select rebateDefineCharacter.attrext15 as define1 FROM voucher.rebate.AmountRebate where id='" + datas[0].agentfid + "'", "marketingbill");
    let body = {
      rebateid: resultcustsql[0].define1,
      rebateMoney: datas[0].rebateMoney,
      agentfid: datas[0].agentfid
    };
    return { body };
