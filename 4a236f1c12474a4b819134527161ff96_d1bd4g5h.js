...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    let access_token = getToken("6bb264f9b16041a193000933716ca0ef", "51f38239770d4e3da35b7346e8a5a4ff");
    let data = param.data[0];
    let body = {
      ChannelAgentID: data.id, //客户费用金额id
      ChannelAgentCode: data.code, //客户费用金额单号
      rebateid: data.rebateDefineCharacter.attrext15, //返利政策id
      UserAgentId: data.agentId, //客户id
      agentId_name: data.agentId_name, //客户名称
      UseMoney: data.rebateMoney //使用金额
    };
    let header = {
    ...
    let apiResponse = apiman("post", "https://www.example.com/" + access_token, JSON.stringify(header), JSON.stringify(body));
    return {};
