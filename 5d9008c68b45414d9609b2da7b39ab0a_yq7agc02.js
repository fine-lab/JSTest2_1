...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var idnumber = "1656930720039305225"; //销售出库单主键
    var codeValue = "XSCK20230211000076"; //销售出库单编码
    ...
    if (fxxKidRes.length == 1 && fxxKidRes[0].define1 != null) {
      ...
      for (var i = 0; i < bodyRes.length; i++) {
        ...
        if (pruRes.length == 1 && pruRes[0].define1 != null) {
          ...
          if (bodydata.qtyName.indexOf("个") > -1) {
            ...
            throw new Error("推送纷享销客失败：纷享销客系统无【" + bodydata.qtyName + "】！单位");
          }
          //查询物料对应的纷享销客产品id
      ...
      throw new Error(JSON.stringify(DeliveryNoteProductObj));
