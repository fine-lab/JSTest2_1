viewModel.on("customInit", function (data) {
  ...
  debugger;
  //调用接口后执行的操作
  let merchantInfo = cb.rest.invokeFunction(
    "GT80750AT4.backOpenApiFunction.merchantInfo",
    {
  ...
  if (merchantInfo) {
    agentname = JSON.parse(merchantInfo.result.apiResponse).data.name.zh_CN;
  }
  //设置查询区的默认值
