...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    for (let page = 1; page <= totalPage; page++) {
      //请求体
      var mess =
        "end_time=" + fmt1 + "&include_wm_order=true&mch_id=1000000057&nonce_str=2696142511&page_no=" + page + "&page_size=100&start_time=" + fmt + "&store_id=24&key=9b9e3ef5a8464cc59ac338289c7844d4";
