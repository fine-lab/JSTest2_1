...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var queryHsql = "select * from voucher.salereturn.SaleReturn where id='" + id + "'";
      ...
      datas: [
        {
          ...
          salereturnDefineCharacter: {
            attrext5: flagValue,
            id: hRes[0].salereturnDefineCharacter.id
          }
        }
      ]
    };
    ...
    let url = httpurl + "/yonbip/sd/api/updateSaleReturnDefineCharacter";
