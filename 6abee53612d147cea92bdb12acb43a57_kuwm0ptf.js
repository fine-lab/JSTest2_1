          ...
          if (!(-1 >= a + c || this.moduleCount <= a + c))
            for (var d = -1; 7 >= d; d++)
              -1 >= b + d ||
                ...
                (this.modules[a + c][b + d] = (c >= 0 && 6 >= c && (0 == d || 6 == d)) || (d >= 0 && 6 >= d && (0 == c || 6 == c)) || (c >= 2 && 4 >= c && d >= 2 && 4 >= d) ? !0 : !1);
      },
    ...
    o = (function () {
      ...
      return (
        (a.prototype.draw = function (a) {
          function g(a, b) {
            var c = document.createElementNS("https://www.example.com/", a);
          ...
          h.setAttributeNS("https://www.example.com/", "xmlns:xlink", "https://www.example.com/"),
            c.appendChild(h),
            h.appendChild(g("rect", { fill: b.colorDark, width: "1", height: "1", id: "youridHere" }));
          for (var i = 0; d > i; i++)
            for (var j = 0; d > j; j++)
              if (a.isDark(i, j)) {
                var k = g("use", { x: String(i), y: String(j) });
                k.setAttributeNS("https://www.example.com/", "href", "#template"), h.appendChild(k);
              }
        }),
