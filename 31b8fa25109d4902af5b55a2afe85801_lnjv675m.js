...
class MyAPIHandler extends AbstractAPIHandler {
  execute(context, param) {
    var access_token = getToken("c41d5c2b69084243b37693640e2e9c2f", "8a33bb246da5470185ac927faccbce49");
    //获取token方法
    ...
    function postdatawithtoken(tocken, url, body) {
      const header = {
        "Content-Type": "application/json"
      };
      var list_body_strResponse = postman("post", url + "?access_token=" + tocken, JSON.stringify(header), JSON.stringify(body));
      var Response = JSON.parse(list_body_strResponse);
      return Response;
    }
    function getdatawithtoken(tocken, url) {
      var list_body_strResponse = postman("get", url + "?access_token=" + tocken, null, null);
      var Response = JSON.parse(list_body_strResponse);
      return Response;
    }
    var url = "https://www.example.com/";
    var accept = getdatawithtoken(access_token, url);
