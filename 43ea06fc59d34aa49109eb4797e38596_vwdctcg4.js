...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    let sqlMain = "select * from  GT4691AT1.GT4691AT1.MFrontSaleOrderMain where dr=0 and code = '" + request.mstCode + "'";
    ...
    let sqlGift =
      ...
      "' and fdTaxMoney=0 and dr=0  and MFrontSaleOrderDetFk.createTime between  '" +
      startDate +
      "' and '" +
      endDate +
      " 23:59:59" +
    ...
    let sqlTotal = "select sum(fdTaxMoney) as totalMoney  from GT4691AT1.GT4691AT1.MFrontSaleOrderDet where  MFrontSaleOrderDetFk.code='" + giftLimit.mstCode + "' and dr=0";
    ...
    let sumSql =
      ...
      giftLimit.customer +
      "' and dr=0 and MFrontSaleOrderDetFk.fmLegalEntity='" +
      giftLimit.legalEntity +
