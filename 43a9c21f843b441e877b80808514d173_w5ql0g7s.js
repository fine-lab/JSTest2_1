...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var access_token = getToken("e2f18d0aaad346b5b24c4c4c7550abb0", "26288a3f3b9148409f085072c540db06");
    let req_token_body = {
      data: {
        orgid_name: "",
        orgid: "youridHere",
    ...
    rows.forEach((row) => {
      ...
      let lrc = ["https://www.example.com/", access_token, "&custdocdefid=2243352965648640"];
