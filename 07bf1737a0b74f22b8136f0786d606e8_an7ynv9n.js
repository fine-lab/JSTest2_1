...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    if (context == undefined || context.appkey == undefined || context.appsecrect == undefined) {
      throw new Error("[getTokenYS] 请正确传入密钥：appkey与appsecrect!");
    } else {
      var appkey = context.appkey; // "7f81edb6809746e9832e21d23b5e2b85";
      var appsecrect = context.appsecrect; // "ad82d2a7971349c9adaafc816789ec24";
    }
    var access_token = getToken(appkey, appsecrect);
    //获取token方法
