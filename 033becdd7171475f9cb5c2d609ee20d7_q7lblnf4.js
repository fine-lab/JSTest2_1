...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var sql = "select hanshuijine from GT68603AT4.GT68603AT4.jinchengjiliangzb where jinchengjiliangdan_id = '" + request.id + "'";
    ...
    let apiResponse = ""; //openLinker("post", base_path, "GT68603AT4", JSON.stringify(body));// openLinker("post", base_path, "GT68603AT4", JSON.stringify(body));
    return { apiResponse };
