...
viewModel.get("button32be") &&
  viewModel.get("button32be").on("click", function (data) {
    //按钮--单击
    ...
    for (var i = 0; i < listModel.length; i++) {
      console.log(listModel[i]); //选中行数据
      cb.rest.invokeFunction("BBSMK.hdjb.salesReturn2", { data: listModel[i] }, function (err, res) {
        console.log(res);
        console.log(err);
      });
    }
