        ...
        proxy.queryData(param, function (err, result) {
          ...
          if (err.data !== undefined) {
            ...
            if (rowdata.isSerialNoManage) {
              ...
              mainGirdModel.insertRow(idn, barcodedata);
              if (err.data[0].isbatchman == "Y") {
              ...
              if (err.data[0].isDate == "Y") {
                mainGirdModel.setCellState(idn, "productdate", "disabled", false);
              } else {
                mainGirdModel.setCellState(idn, "productdate", "disabled", true);
              }
