...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    if (billType == "purinrecord_list" || billType.indexOf("purinrecord") > -1) {
      //采购入库
      orderDetailSonKey = "yourKeyHere";
    } else if (billType == "storeprorecord_list" || billType.indexOf("storeprorecord") > -1) {
      //产品入库
      orderDetailSonKey = "yourKeyHere";
    }
