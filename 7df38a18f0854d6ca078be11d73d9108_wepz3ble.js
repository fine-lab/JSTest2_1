...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var detailsql =
      "select org,project,description,debit_subjects,debit_subjects2,credit_subjects,customer,bankaccbas,banktype,debit_amount,debit_charge,credit_amount from GT17832AT1.GT17832AT1.subdistribdetail where subdistribdetailFk ='" +
      businessid +
      "'";
    ...
    let bankaccFun = extrequire("GT17832AT1.common.getbankaccbas");
    ...
    if ("200" === result.code) {
      ...
      var res = ObjectStore.updateById("GT17832AT1.GT17832AT1.subdistrib", object, "subdistrib");
    }
    return {
      resp,
      voucherSaveResp
