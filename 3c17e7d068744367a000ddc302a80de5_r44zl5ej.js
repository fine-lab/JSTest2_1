...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var userid, username, userorgid, userorgname, userdeptid, userdeptname;
    if ("1" == resultJSON.status && resultJSON.data != null) {
      ...
      return { userid: userid, username: username, userorgid: userorgid, userorgname: userorgname, userdeptid: userdeptid, userdeptname: userdeptname };
    } else {
