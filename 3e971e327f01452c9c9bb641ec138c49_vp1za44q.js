...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var PricingSql =
      "select * from AT15F164F008080007.AT15F164F008080007.pricTable where merchant = '" + settlementresId + "' and project = '" + testingsId + "' and sydType = '" + sampleReceiptId + "' and dr = 0";
    ...
    //税率id
    var taxrateresId = Pricingres[0].id;
