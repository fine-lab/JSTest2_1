...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    //使用公共函数--------------begin
    let func1 = extrequire("GT98518AT135.free.getOpenApiToken");
    let res = func1.execute(request);
    let configfun = extrequire("GT98518AT135.free.getdetil");
    ...
    if (responseObj.data.failCount == 0) {
      ...
      ObjectStore.updateById("GT98518AT135.GT98518AT135.prepayment_zh", object, "338ec443");
    }
    return { responseObj };
  }
}
