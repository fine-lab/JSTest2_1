...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    var detailsql = "select org,project,description,debit_subjects,credit_subjects,customer,amount  from GT20457AT2.GT20457AT2.smarttourismdetail where smarttourismdetailFk ='" + businessid + "'";
    ...
    if ("200" === result.code) {
      ...
      var res = ObjectStore.updateById("GT20457AT2.GT20457AT2.smarttourism", object, "smarttourism");
    }
    return {
      resp,
      voucherSaveResp
