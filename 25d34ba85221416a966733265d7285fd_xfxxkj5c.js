cb.defineInner([], function () {
  var MyExternal = {
    getAccessToken() {
      const appKey = "yourKeyHere";
      const appSecrect = "3f31de5983a04b90a8dc3a9c0e0fe477";
      ...
      const access_token_params = getToken(appKey, appSecrect, baseurl);
      return access_token_params;
    }
  };
  return MyExternal;
});