...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    try {
      ...
      let jt01 = body.data.orderDefineCharacter.attrext70 ? body.data.orderDefineCharacter.attrext70 * 0.01 : 0; //物料行津贴
      let jt02 = body.data.orderDefineCharacter.attrext71 ? body.data.orderDefineCharacter.attrext71 * 0.01 : 0; //津贴
      let jt03 = body.data.orderDefineCharacter.attrext78 ? body.data.orderDefineCharacter.attrext78 * 0.01 : 0; //现金折扣
