...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    for (var i = 0; i < mainRes.length; i++) {
      ...
      //校验凭证号是否存在    where dr = 0 and accBook = '"+zhbcode+"'
    ...
    //获取样本编号;
    var ponseSql = "select id,checkStatus from AT15F164F008080007.AT15F164F008080007.DetectOrder where dr = 0 and pingzhenghao = '" + OddNumbers + "' and importData = '" + date + "'";
