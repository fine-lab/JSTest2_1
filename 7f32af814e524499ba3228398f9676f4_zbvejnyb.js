...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    xiaoguochengben = res[0].xiaoguochengben;
    ...
    var toUpdate = { zhixingjine: shijihezuojine, gongzhonghaocaigoujine: shijicaigoujiage, koccaigouchengben: ziduan34, xiaoguochengben: xiaoguochengben, caigoushuifeidikou: caigoushuifeidikou };
