...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    //获取合同对象
    var contractData = param.data;
    for (var k = 0; k < contractData.length; k++) {
      //获取合同关联房间表
      var houseList = ObjectStore.selectByMap("GT40934AT6.GT40934AT6.lease_a_contract_house", { lease_a_contract_id: contractData[k].id });
      //获取运行状态 "空置中"  记录id
