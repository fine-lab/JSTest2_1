...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    var access_token = getToken("281b70c006d14dcbaf79672afb0862ea", "bf1d139181bb4ee9b19ee8e1fcff6214");
    var PurDATES = PurDATEES(access_token);
    //获取采购接口方法
    function PurDATEES(access_token) {
      //设置返回的access_token
      // 获取token的url
      ...
      const requestUrl = token_url + "?access_token=" + access_token + "&Body=" + Body;
      var strResponse = postman("post", requestUrl, JSON.stringify(header), JSON.stringify(Body));
      //获取采购列表值
      var responseObj = JSON.parse(strResponse);
      var PurDate = responseObj.data;
      return { PurDate: PurDate };
    }
