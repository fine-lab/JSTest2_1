...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    if (mainObj.id != undefined) {
      ...
      //删除记录
      var res = ObjectStore.deleteBatch("GT4691AT1.GT4691AT1.MRebateAmountLog", rebateList);
      //更新记录
      var res = ObjectStore.updateBatch("GT4691AT1.GT4691AT1.MRebateAmountLog", updateRecords);
