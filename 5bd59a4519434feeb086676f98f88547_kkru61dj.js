...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    if (typeof sy_lincenseList != "undefined" && sy_lincenseList != null) {
      for (let i = 0; i < sy_lincenseList.length; i++) {
        ...
        lincenseInfo.enclosure = sy_lincenseList[i].file;
        //显示用证照
        let get_license_sub_res = sy_lincenseList[i][sy_zz_fw];
        let customerLicenseRangeList = [];
        if (get_license_sub_res != null && typeof get_license_sub_res != "undefined" && get_license_sub_res.length != null) {
    ...
    if (typeof authInfos != "undefined" && authInfos != null) {
      for (let i = 0; i < authInfos.length; i++) {
        ...
        let authRangeList = [];
        if (typeof get_auth_sub_res != "undefined" && get_auth_sub_res != null) {
    ...
    if (typeof supplierInfoJsonLincense != "undefined" && supplierInfoJsonLincense != null) {
      for (let i = 0; i < supplierInfoJsonLincense.length; i++) {
        ...
        if (typeof supplierInfoJsonLincense_fw != "undefined" && supplierInfoJsonLincense_fw != null) {
    ...
    if (typeof supplierInfoJsonAuth != "undefined" && supplierInfoJsonAuth != null) {
      for (let i = 0; i < supplierInfoJsonAuth.length; i++) {
        ...
        if (typeof supplierInfoJsonAuth_fw != "undefined" && supplierInfoJsonAuth_fw != null) {
    ...
    if (supplier_report != undefined && supplier_report != null) {
