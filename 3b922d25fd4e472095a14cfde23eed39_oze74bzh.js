...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    var myDate = new Date();
    var code = myDate.getHours() + myDate.getMinutes() + myDate.getSeconds() + myDate.getMilliseconds();
    var access_token = getToken("e1c22d34e26c4bcbac282c70c69240bf", "17bc3af31b134cb48cc5b534852f58fd");
    let req_token_body = {
      data: {
        orgid_name: "",
        orgid: "youridHere",
        ...
        pubts: "",
        creator_userName: "",
        creationtime: "2020-08-29 15:54:57",
        modifier_userName: "",
        modifiedtime: "2020-08-29 15:54:57",
        custdocdefid: "youridHere",
        dr: "0",
        _status: ""
      }
    };
    var yourappkey = request.appKey;
    var yourappsecrect = request.appSecret;
    ...
    rows.forEach((row) => {
      ...
      var code = row["code"];
      data.data = {};
      data.data.orgid_name = row["org_id_realname"];
      data.data.orgid = row["org_id"];
      data.data.code = code;
      data.data.name = name;
      data.data.custdocdefid = "youridHere";
      data.data.dr = "0";
      data.data.enable = 1;
      data.data._status = "Insert";
      data.data.id = row["GL_itemID"];
      var dat = JSON.stringify(data);
      let lrc = ["https://www.example.com/", access_token, "&custdocdefid=2167960314450432"];
      var strResponse = postman("post", lrc.join(""), null, dat);
    });
