run = function (event) {
  ...
  viewModel.on("afterMount", function () {
    viewModel.on("afterLoadData", function () {
      ...
      if (viewModel.getParams().mode == "add") {
        ...
        let sourceBillNo = viewModel.get("sourceBillNo").getValue();
        ...
        getInspectionResults(businessType, orgId, sourceBillNo, productId);
        getGMPMaterialFiles(orgId, productId);
        if (businessType == "1") {
          getReleaseOrder(remark, source_id, sourcechild_id, source_billtype, orgId, productSku, productId, businessType);
      ...
      invokeFunction1(
        ...
        function (err, res) {
          ...
          if (typeof res != "undefined" && res != null) {
            if (typeof res.releasePlan != "undefined" && res.releasePlan != null) {
  ...
  function selectReleasePlanMaterial(orgId, materialId, skuId, businessType, releasePlan) {
    return new Promise((resolve) => {
      ...
      invokeFunction1(
        ...
        function (err, res) {
          if (typeof res != "undefined" && res != null) {
            if (typeof res.releasePlanData != "undefined" && res.releasePlanData != null) {
  ...
  function getGMPMaterialFiles(orgId, materialId) {
    return new Promise((resolve) => {
      ...
      invokeFunction1(
        ...
        function (err, res) {
          if (typeof res != "undefined" && res != null) {
            if (typeof res.proMasterRes != "undefined" && res.proMasterRes != null) {
  ...
  //获取检验结果
  function getInspectionResults(businessType, orgId, sourceBillNo, productId) {
    return new Promise((resolve) => {
      let invokeFunction1 = function (id, data, callback, viewModel, options) {
        var proxy = cb.rest.DynamicProxy.create({
          doProxy: {
      ...
      invokeFunction1(
        "ISY_2.backOpenApiFunction.getInspectResult",
        {
          businessType: businessType,
        ...
        function (err, res) {
          if (typeof res != "undefined" && res != null) {
            if (typeof res.inspectResultRes != "undefined" && res.inspectResultRes != null) {
              let inspectResultRes = res.inspectResultRes;
              if (inspectResultRes.length > 0) {
                let inspectResult = inspectResultRes[0].inspectResult;
                if (inspectResult == "1") {
                  viewModel.get("inspectionresults").setValue("合格");
                } else if (inspectResult == "2") {
                  viewModel.get("inspectionresults").setValue("不合格");
                }
                resolve(inspectResultRes);
              }
            }
          } else if (typeof err != "undefined" && err != null) {
            cb.utils.alert(err.message, "error");
