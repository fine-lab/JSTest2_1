...
class WorkflowAPIHandler extends AbstractWorkflowAPIHandler {
  ...
  processInstanceEnd(processStateChangeMessage) {
    ...
    let sql = "select verifystate,id,code,attach,contno  from GT89699AT3.GT89699AT3.invoiceapply   where id = '" + businessId + "'";
    ...
    if (audit == 2) {
      ...
      for (let i in resarray) {
        ...
        let apiResponse1 = postman("post", "http://117.35.158.238:2105/service/operod?dataType=Archivesfile", JSON.stringify(header1), JSON.stringify(body1));
      }
    }
  }
  // 环节结束
