...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    //依据组织、客户id查询对应的平均价设置
    let queryChooseSql =
      "select * from GT83441AT1.GT83441AT1.avgMoneyChoose where id in (select avgMoneyChoose_id from GT83441AT1.GT83441AT1.avgMoneyChoose_b where dr=0 and customer=" +
      agentId +
      ") and dr=0 and org_id=" +
      orgid;
    var chooseRes = ObjectStore.queryByYonQL(queryChooseSql);
