...
class MyAPIHandler extends AbstractAPIHandler {
  execute(request) {
    ...
    ybresult.forEach((data) => {
      ...
      if ((apiResponseJson.respCode = "0000")) {
        var object = new Object();
        object.iscreathmdordr = "1";
        object.id = data.id;
        object.hmdorderid = apiResponseJson.data.orderId;
        let res = ObjectStore.updateById("GT1281AT3.GT1281AT3.reqbuy1", object);
      }
    });
    //数据转换-----------------------end
