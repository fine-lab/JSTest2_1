...
class MyTrigger extends AbstractTrigger {
  execute(context, param) {
    ...
    var zhkjdate = replace(kjdate, "-", "00");
    let resMessage = new Object();
    let body = { accbook: "3075DCE7-B15A-4AA6-A3E6-B0E96D23204F", period: kjdate };
    ...
    finseDataVO.kjdate = zhkjdate;
    //将数据插入数据库
    //先删除数据库的对应数据
    var querySql = "select id from GT23468AT1.GT23468AT1.gl_finservice_f203 where  kjdate = '" + zhkjdate + "'";
    var queryData = ObjectStore.queryByYonQL(querySql);
    var res = ObjectStore.deleteById("GT23468AT1.GT23468AT1.gl_finservice_f203", queryData, "edcb8a01");
